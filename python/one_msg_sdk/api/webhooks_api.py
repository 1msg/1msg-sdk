...
class WebhooksApi:
    ...
    def set_webhook(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        get_webhook200_response: Optional[GetWebhook200Response] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param token: JWT token or API key for authorization (required)
        :type token: str
        :param get_webhook200_response:
        :type get_webhook200_response: GetWebhook200Response
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_webhook_serialize(
            token=token,
            get_webhook200_response=get_webhook200_response,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def set_webhook_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        get_webhook200_response: Optional[GetWebhook200Response] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def set_webhook_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        get_webhook200_response: Optional[GetWebhook200Response] = None,
        _request_timeout: Union[
    ...
    def _set_webhook_serialize(
        self,
        token,
        get_webhook200_response,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_webhook200_response is not None:
            _body_params = get_webhook200_response
