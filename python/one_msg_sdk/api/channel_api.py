...
class ChannelApi:
    ...
    def get_conversational_automation(
        ...
        _param = self._get_conversational_automation_serialize(
            token=token,
    ...
    @validate_call
    def get_conversational_automation_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConversationalAutomation]:
        """Get conversational automation settings
    ...
    @validate_call
    def get_conversational_automation_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        _request_timeout: Union[
            None,
    ...
    def _get_conversational_automation_serialize(
        self,
        token,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/conversationalAutomation',
    ...
    @validate_call
    def set_conversational_automation(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        ...
        :param token: JWT token or API key for authorization (required)
        :type token: str
        :param conversational_automation: (required)
        :type conversational_automation: ConversationalAutomation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_conversational_automation_serialize(
            token=token,
    ...
    @validate_call
    def set_conversational_automation_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        conversational_automation: ConversationalAutomation,
        _request_timeout: Union[
    ...
    @validate_call
    def set_conversational_automation_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        conversational_automation: ConversationalAutomation,
        _request_timeout: Union[
    ...
    def _set_conversational_automation_serialize(
        self,
        token,
        ...
        # process the form parameters
        # process the body parameter
        if conversational_automation is not None:
            _body_params = conversational_automation
