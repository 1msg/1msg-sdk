...
class CatalogApi:
    ...
    def create_commerce(
        ...
        create_commerce_request: CreateCommerceRequest,
        ...
        :type token: str
        :param create_commerce_request: (required)
        :type create_commerce_request: CreateCommerceRequest
        ...
        _param = self._create_commerce_serialize(
            token=token,
            create_commerce_request=create_commerce_request,
    ...
    @validate_call
    def create_commerce_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        create_commerce_request: CreateCommerceRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def create_commerce_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        create_commerce_request: CreateCommerceRequest,
        _request_timeout: Union[
    ...
    def _create_commerce_serialize(
        self,
        token,
        create_commerce_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_commerce_request is not None:
            _body_params = create_commerce_request
    ...
    def get_commerce(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[GetCommerce200ResponseInner]:
        ...
        _param = self._get_commerce_serialize(
            token=token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetCommerce200ResponseInner]",
            '401': "ErrorResponse",
            '500': "ErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_commerce_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetCommerce200ResponseInner]]:
        """Get Commerce Settings
    ...
    @validate_call
    def get_commerce_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="JWT token or API key for authorization")],
        _request_timeout: Union[
            None,
