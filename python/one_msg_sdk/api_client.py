...
from one_msg_sdk.configuration import Configuration
from one_msg_sdk.api_response import ApiResponse, T as ApiResponseT
import one_msg_sdk.models
from one_msg_sdk import rest
from one_msg_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(one_msg_sdk.models, klass)
