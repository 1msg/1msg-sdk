...
class CreateCommerceRequestParams(BaseModel):
    """
    CreateCommerceRequestParams
    """ # noqa: E501
    is_cart_enabled: StrictBool = Field(description="Enable cart")
    is_catalog_visible: StrictBool = Field(description="Show catalog storefront icon")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["is_cart_enabled", "is_catalog_visible"]
