...
class UpdateMeRequest(BaseModel):
    ...
    UpdateMeRequest
    """ # noqa: E501
    about: Optional[StrictStr] = Field(default=None, description="Profile About section")
    address: Optional[StrictStr] = None
    description: Optional[StrictStr] = Field(default=None, description="Business description (max 256 characters)")
    email: Optional[StrictStr] = None
    vertical: Optional[StrictStr] = Field(default=None, description="Industry of the business")
    photo: Optional[StrictStr] = Field(default=None, description="HTTPS URL or data:image/...;base64,... payload")
    websites: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["about", "address", "description", "email", "vertical", "photo", "websites"]
