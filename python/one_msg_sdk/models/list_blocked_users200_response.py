...
class ListBlockedUsers200Response(BaseModel):
    """
    ListBlockedUsers200Response
    """ # noqa: E501
    blocked_users: Optional[List[Dict[str, Any]]] = Field(default=None, alias="blockedUsers")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["blockedUsers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blockedUsers": obj.get("blockedUsers")
        })
