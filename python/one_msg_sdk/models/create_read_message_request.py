...
class CreateReadMessageRequest(BaseModel):
    """
    CreateReadMessageRequest
    """ # noqa: E501
    message_id: Optional[StrictStr] = Field(default=None, alias="messageId")
    msg_id: Optional[StrictStr] = Field(default=None, alias="msgId")
    typing_indicator: Optional[StrictBool] = Field(default=False, description="Show WhatsApp typing indicator (max 25s or until reply)", alias="typingIndicator")
    __properties: ClassVar[List[str]] = ["messageId", "msgId", "typingIndicator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "msgId": obj.get("msgId"),
            "typingIndicator": obj.get("typingIndicator") if obj.get("typingIndicator") is not None else False
        })
        return _obj
