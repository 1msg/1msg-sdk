...
class PatchFlowsFlowIdAssets200Response(BaseModel):
    """
    PatchFlowsFlowIdAssets200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    validation_errors: Optional[List[Dict[str, Any]]] = Field(default=None, alias="validationErrors")
    error: Optional[Any] = Field(default=None, description="Error details returned by the provider. May be a string or a JSON object.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "validationErrors", "error"]
