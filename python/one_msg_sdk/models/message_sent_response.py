...
class MessageSentResponse(BaseModel):
    ...
    """ # noqa: E501
    sent: Optional[StrictBool] = Field(default=None, description="Whether the message was successfully queued for sending")
    id: Optional[StrictStr] = Field(default=None, description="Message ID")
    ...
    __properties: ClassVar[List[str]] = ["sent", "id", "message", "description"]
