...
class GetCommerce200ResponseInner(BaseModel):
    """
    GetCommerce200ResponseInner
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Catalog id")
    is_cart_enabled: Optional[StrictBool] = Field(default=None, description="Whether the cart is enabled")
    is_catalog_visible: Optional[StrictBool] = Field(default=None, description="Whether the catalog storefront icon is shown")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "is_cart_enabled", "is_catalog_visible"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "is_cart_enabled": obj.get("is_cart_enabled"),
            "is_catalog_visible": obj.get("is_catalog_visible")
        })
