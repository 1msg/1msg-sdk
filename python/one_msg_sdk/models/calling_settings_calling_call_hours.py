...
class CallingSettingsCallingCallHours(BaseModel):
    """
    Optional call hours / timezone configuration (Meta shape)
    """ # noqa: E501
    status: Optional[StrictStr] = None
    timezone: Optional[StrictStr] = None
    day_of_week_start: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "timezone", "day_of_week_start"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "day_of_week_start": obj.get("day_of_week_start")
        })
