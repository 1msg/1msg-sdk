...
class SendListRequestSectionsInner(BaseModel):
    """
    SendListRequestSectionsInner
    """ # noqa: E501
    title: Optional[StrictStr] = None
    rows: Optional[List[SendListRequestSectionsInnerRowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "rows": [SendListRequestSectionsInnerRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
