...
class SendContactRequest(BaseModel):
    ...
    contacts: Optional[List[SendContactRequestContactsInner]] = None
    __properties: ClassVar[List[str]] = ["phone", "contacts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "phone": obj.get("phone"),
            "contacts": [SendContactRequestContactsInner.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None
        })
        return _obj
