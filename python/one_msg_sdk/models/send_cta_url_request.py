...
class SendCtaUrlRequest(BaseModel):
    """
    SendCtaUrlRequest
    """ # noqa: E501
    ...
    body: StrictStr
    display_text: StrictStr = Field(description="Button label", alias="displayText")
    url: StrictStr
    header: Optional[Dict[str, Any]] = None
    footer: Optional[StrictStr] = None
    quoted_msg_id: Optional[StrictStr] = Field(default=None, alias="quotedMsgId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["phone", "chatId", "body", "displayText", "url", "header", "footer", "quotedMsgId"]
