...
class UpdateCallingSettings200Response(BaseModel):
    """
    UpdateCallingSettings200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    result: Optional[StrictStr] = None
    response: Optional[UpdateCallingSettings200ResponseResponse] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "result", "response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": UpdateCallingSettings200ResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
