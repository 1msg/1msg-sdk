...
class SendOrderDetailsRequestOrderItemsInner(BaseModel):
    """
    SendOrderDetailsRequestOrderItemsInner
    """ # noqa: E501
    retailer_id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    quantity: Optional[StrictInt] = None
    amount: Optional[SendOrderDetailsRequestOrderItemsInnerAmount] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["retailer_id", "name", "quantity", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "retailer_id": obj.get("retailer_id"),
            "name": obj.get("name"),
            "quantity": obj.get("quantity"),
            "amount": SendOrderDetailsRequestOrderItemsInnerAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None
        })
