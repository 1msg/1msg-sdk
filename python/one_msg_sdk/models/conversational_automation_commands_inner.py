...
class ConversationalAutomationCommandsInner(BaseModel):
    """
    ConversationalAutomationCommandsInner
    """ # noqa: E501
    command_name: Annotated[str, Field(strict=True, max_length=32)]
    command_description: Annotated[str, Field(strict=True, max_length=256)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["command_name", "command_description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "command_description": obj.get("command_description")
        })
