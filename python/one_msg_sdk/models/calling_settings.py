...
class CallingSettings(BaseModel):
    ...
    """ # noqa: E501
    calling: Optional[CallingSettingsCalling] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["calling"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of calling
        if self.calling:
            _dict['calling'] = self.calling.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calling": CallingSettingsCalling.from_dict(obj["calling"]) if obj.get("calling") is not None else None
        })
