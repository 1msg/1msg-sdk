...
class SendStickerRequest(BaseModel):
    ...
    media_id: Optional[StrictStr] = Field(default=None, description="WABA media id from uploadMedia", alias="mediaId")
    link: Optional[StrictStr] = Field(default=None, description="Public URL to webp sticker")
    quoted_msg_id: Optional[StrictStr] = Field(default=None, alias="quotedMsgId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["phone", "chatId", "mediaId", "link", "quotedMsgId"]
