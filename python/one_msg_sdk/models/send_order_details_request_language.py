...
class SendOrderDetailsRequestLanguage(BaseModel):
    """
    Template language
    """ # noqa: E501
    code: StrictStr = Field(description="Language code")
    policy: Optional[StrictStr] = Field(default=None, description="Optional language policy")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "policy"]
