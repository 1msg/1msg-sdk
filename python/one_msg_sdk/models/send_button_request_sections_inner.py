...
class SendButtonRequestSectionsInner(BaseModel):
    """
    SendButtonRequestSectionsInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    reply: Optional[SendButtonRequestSectionsInnerReply] = None
    __properties: ClassVar[List[str]] = ["type", "reply"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "reply": SendButtonRequestSectionsInnerReply.from_dict(obj["reply"]) if obj.get("reply") is not None else None
        })
        return _obj
