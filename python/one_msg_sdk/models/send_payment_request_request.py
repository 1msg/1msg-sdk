...
class SendPaymentRequestRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["phone", "region", "body", "interactive", "action"]

    @field_validator('region')
    def region_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IN', 'SG', 'BR']):
            raise ValueError("must be one of enum values ('IN', 'SG', 'BR')")
        return value
