...
class CallingSettingsCallingSip(BaseModel):
    """
    ...
    servers: Optional[List[CallingSettingsCallingSipServersInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "servers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servers": [CallingSettingsCallingSipServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None
        })
