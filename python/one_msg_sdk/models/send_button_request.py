...
class SendButtonRequest(BaseModel):
    ...
    sections: Optional[List[SendButtonRequestSectionsInner]] = None
    __properties: ClassVar[List[str]] = ["phone", "body", "footer", "sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sections": [SendButtonRequestSectionsInner.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
