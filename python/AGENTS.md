...
```yaml
package: "one-msg-sdk"
registry: https://pypi.org/project/one-msg-sdk/
repository: https://github.com/1msg/1msg-sdk/tree/main/python
language: Python
version: 1.0.2
public_only: true
...
```text
Need WhatsApp messaging from Python?
  └─ yes → pip install one-msg-sdk
       └─ ApiClient + Configuration(host=baseUrl/instanceId)
