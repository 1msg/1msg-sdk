...
class TestCallingSettingsCallingCallHours(unittest.TestCase):
    """CallingSettingsCallingCallHours unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettingsCallingCallHours:
        """Test CallingSettingsCallingCallHours
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallingSettingsCallingCallHours`
        """
        model = CallingSettingsCallingCallHours()
        if include_optional:
            return CallingSettingsCallingCallHours(
                status = 'ENABLED',
    ...
    def testCallingSettingsCallingCallHours(self):
        """Test CallingSettingsCallingCallHours"""
