...
class TestCallingSettingsCallingAudio(unittest.TestCase):
    """CallingSettingsCallingAudio unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettingsCallingAudio:
        """Test CallingSettingsCallingAudio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallingSettingsCallingAudio`
        """
        model = CallingSettingsCallingAudio()
        if include_optional:
            return CallingSettingsCallingAudio(
                status = ''
            )
        else:
            return CallingSettingsCallingAudio(
    ...
    def testCallingSettingsCallingAudio(self):
        """Test CallingSettingsCallingAudio"""
