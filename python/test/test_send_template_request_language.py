...
class TestSendTemplateRequestLanguage(unittest.TestCase):
    """SendTemplateRequestLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendTemplateRequestLanguage:
        """Test SendTemplateRequestLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendTemplateRequestLanguage`
        """
        model = SendTemplateRequestLanguage()
        if include_optional:
            return SendTemplateRequestLanguage(
                policy = '',
                code = ''
            )
        else:
    ...
    def testSendTemplateRequestLanguage(self):
        """Test SendTemplateRequestLanguage"""
