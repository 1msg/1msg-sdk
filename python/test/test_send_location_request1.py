...
class TestSendLocationRequest1(unittest.TestCase):
    """SendLocationRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendLocationRequest1:
        """Test SendLocationRequest1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendLocationRequest1`
        """
        model = SendLocationRequest1()
        if include_optional:
            return SendLocationRequest1(
                lat = '',
                lng = '',
                address = '',
                name = '',
    ...
    def testSendLocationRequest1(self):
        """Test SendLocationRequest1"""
