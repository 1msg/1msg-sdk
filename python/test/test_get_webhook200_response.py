...
class TestGetWebhook200Response(unittest.TestCase):
    """GetWebhook200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWebhook200Response:
        """Test GetWebhook200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWebhook200Response`
        """
        model = GetWebhook200Response()
        if include_optional:
    ...
    def testGetWebhook200Response(self):
        """Test GetWebhook200Response"""
