...
class TestCreateReadMessageRequest(unittest.TestCase):
    """CreateReadMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateReadMessageRequest:
        """Test CreateReadMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateReadMessageRequest`
        """
        model = CreateReadMessageRequest()
        if include_optional:
            return CreateReadMessageRequest(
                message_id = '',
                msg_id = '',
    ...
    def testCreateReadMessageRequest(self):
        """Test CreateReadMessageRequest"""
