...
class TestSendAddressMessageRequest(unittest.TestCase):
    """SendAddressMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendAddressMessageRequest:
        """Test SendAddressMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendAddressMessageRequest`
        """
        model = SendAddressMessageRequest()
        if include_optional:
            return SendAddressMessageRequest(
                phone = 56,
                chat_id = '',
                body = '',
                country = 'SG',
    ...
    def testSendAddressMessageRequest(self):
        """Test SendAddressMessageRequest"""
