...
class TestSendCarouselRequest1(unittest.TestCase):
    """SendCarouselRequest1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendCarouselRequest1:
        """Test SendCarouselRequest1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendCarouselRequest1`
        """
        model = SendCarouselRequest1()
        if include_optional:
            return SendCarouselRequest1(
                body = '',
                params = [
                    None
                    ],
    ...
    def testSendCarouselRequest1(self):
        """Test SendCarouselRequest1"""
