...
class TestCallingSettingsCallingSipServersInner(unittest.TestCase):
    """CallingSettingsCallingSipServersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettingsCallingSipServersInner:
        """Test CallingSettingsCallingSipServersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallingSettingsCallingSipServersInner`
        """
        model = CallingSettingsCallingSipServersInner()
        if include_optional:
            return CallingSettingsCallingSipServersInner(
    ...
    def testCallingSettingsCallingSipServersInner(self):
        """Test CallingSettingsCallingSipServersInner"""
