...
class TestSendFlowRequestHeader(unittest.TestCase):
    """SendFlowRequestHeader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFlowRequestHeader:
        """Test SendFlowRequestHeader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFlowRequestHeader`
        """
        model = SendFlowRequestHeader()
        if include_optional:
            return SendFlowRequestHeader(
            )
        else:
            return SendFlowRequestHeader(
        )
    ...
    def testSendFlowRequestHeader(self):
        """Test SendFlowRequestHeader"""
