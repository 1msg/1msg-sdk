...
class TestCallingSettings(unittest.TestCase):
    """CallingSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettings:
        """Test CallingSettings
