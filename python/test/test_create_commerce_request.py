...
class TestCreateCommerceRequest(unittest.TestCase):
    """CreateCommerceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommerceRequest:
        """Test CreateCommerceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommerceRequest`
        """
        model = CreateCommerceRequest()
        if include_optional:
            return CreateCommerceRequest(
                params = { }
            )
        else:
            return CreateCommerceRequest(
    ...
    def testCreateCommerceRequest(self):
        """Test CreateCommerceRequest"""
