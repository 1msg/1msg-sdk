...
class TestInitiateCallRequestSession(unittest.TestCase):
    """InitiateCallRequestSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateCallRequestSession:
        """Test InitiateCallRequestSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateCallRequestSession`
        """
        model = InitiateCallRequestSession()
        if include_optional:
            return InitiateCallRequestSession(
                sdp_type = 'offer',
    ...
    def testInitiateCallRequestSession(self):
        """Test InitiateCallRequestSession"""
