...
class TestConversationalAutomation(unittest.TestCase):
    """ConversationalAutomation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationalAutomation:
        """Test ConversationalAutomation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationalAutomation`
        """
        model = ConversationalAutomation()
        if include_optional:
    ...
    def testConversationalAutomation(self):
        """Test ConversationalAutomation"""
