...
class TestGetCommerce200ResponseInner(unittest.TestCase):
    """GetCommerce200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommerce200ResponseInner:
        """Test GetCommerce200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommerce200ResponseInner`
        """
        model = GetCommerce200ResponseInner()
        if include_optional:
    ...
    def testGetCommerce200ResponseInner(self):
        """Test GetCommerce200ResponseInner"""
