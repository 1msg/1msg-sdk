...
class TestConversationalAutomationCommandsInner(unittest.TestCase):
    """ConversationalAutomationCommandsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationalAutomationCommandsInner:
        """Test ConversationalAutomationCommandsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationalAutomationCommandsInner`
        """
        model = ConversationalAutomationCommandsInner()
        if include_optional:
            return ConversationalAutomationCommandsInner(
                command_name = '',
                command_description = ''
            )
        else:
    ...
    def testConversationalAutomationCommandsInner(self):
        """Test ConversationalAutomationCommandsInner"""
