...
class TestCallingSettingsCalling(unittest.TestCase):
    """CallingSettingsCalling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettingsCalling:
        """Test CallingSettingsCalling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallingSettingsCalling`
        """
        model = CallingSettingsCalling()
        if include_optional:
            return CallingSettingsCalling(
                status = 'ENABLED',
    ...
    def testCallingSettingsCalling(self):
        """Test CallingSettingsCalling"""
