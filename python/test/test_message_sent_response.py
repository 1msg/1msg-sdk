...
class TestMessageSentResponse(unittest.TestCase):
    """MessageSentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSentResponse:
