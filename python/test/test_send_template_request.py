...
class TestSendTemplateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendTemplateRequest:
        ...
        if include_optional:
            return SendTemplateRequest(
                template = '',
                language = one_msg_sdk.models.send_template_request_language.sendTemplate_request_language(
                    policy = '', 
                    code = '', ),
                namespace = '',
                params = [
    ...
    def testSendTemplateRequest(self):
        """Test SendTemplateRequest"""
