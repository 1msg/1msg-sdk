...
class TestDeleteMediaLegacyRequest(unittest.TestCase):
    """DeleteMediaLegacyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteMediaLegacyRequest:
        """Test DeleteMediaLegacyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteMediaLegacyRequest`
        """
        model = DeleteMediaLegacyRequest()
        if include_optional:
            return DeleteMediaLegacyRequest(
                media_id = ''
            )
        else:
            return DeleteMediaLegacyRequest(
    ...
    def testDeleteMediaLegacyRequest(self):
        """Test DeleteMediaLegacyRequest"""
