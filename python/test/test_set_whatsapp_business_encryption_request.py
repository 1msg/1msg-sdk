...
class TestSetWhatsappBusinessEncryptionRequest(unittest.TestCase):
    """SetWhatsappBusinessEncryptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetWhatsappBusinessEncryptionRequest:
        """Test SetWhatsappBusinessEncryptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetWhatsappBusinessEncryptionRequest`
        """
        model = SetWhatsappBusinessEncryptionRequest()
        if include_optional:
            return SetWhatsappBusinessEncryptionRequest(
...
',
    ...
    def testSetWhatsappBusinessEncryptionRequest(self):
        """Test SetWhatsappBusinessEncryptionRequest"""
