...
class TestSendPaymentRequestRequest(unittest.TestCase):
    """SendPaymentRequestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendPaymentRequestRequest:
        ...
        if include_optional:
            return SendPaymentRequestRequest(
                phone = 56,
                region = 'IN',
                body = '',
                interactive = { },
    ...
    def testSendPaymentRequestRequest(self):
        """Test SendPaymentRequestRequest"""
