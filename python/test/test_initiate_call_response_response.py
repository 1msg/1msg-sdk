...
class TestInitiateCallResponseResponse(unittest.TestCase):
    """InitiateCallResponseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateCallResponseResponse:
        """Test InitiateCallResponseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateCallResponseResponse`
        """
        model = InitiateCallResponseResponse()
        if include_optional:
            return InitiateCallResponseResponse(
                error = ''
            )
        else:
            return InitiateCallResponseResponse(
    ...
    def testInitiateCallResponseResponse(self):
        """Test InitiateCallResponseResponse"""
