...
class TestCallingSettingsCallingSip(unittest.TestCase):
    """CallingSettingsCallingSip unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallingSettingsCallingSip:
        """Test CallingSettingsCallingSip
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallingSettingsCallingSip`
        """
        model = CallingSettingsCallingSip()
        if include_optional:
            return CallingSettingsCallingSip(
                status = 'DISABLED',
                servers = [
                    { }
                    ]
    ...
    def testCallingSettingsCallingSip(self):
        """Test CallingSettingsCallingSip"""
