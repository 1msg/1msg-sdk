...
class TestSendContactRequestContactsInnerOrg(unittest.TestCase):
    """SendContactRequestContactsInnerOrg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendContactRequestContactsInnerOrg:
        """Test SendContactRequestContactsInnerOrg
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendContactRequestContactsInnerOrg`
        """
        model = SendContactRequestContactsInnerOrg()
        if include_optional:
            return SendContactRequestContactsInnerOrg(
                company = '',
                department = '',
                title = ''
            )
    ...
    def testSendContactRequestContactsInnerOrg(self):
        """Test SendContactRequestContactsInnerOrg"""
