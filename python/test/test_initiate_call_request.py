...
class TestInitiateCallRequest(unittest.TestCase):
    """InitiateCallRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitiateCallRequest:
        """Test InitiateCallRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitiateCallRequest`
        """
        model = InitiateCallRequest()
        if include_optional:
    ...
    def testInitiateCallRequest(self):
        """Test InitiateCallRequest"""
