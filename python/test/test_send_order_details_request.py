...
class TestSendOrderDetailsRequest(unittest.TestCase):
    """SendOrderDetailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendOrderDetailsRequest:
        """Test SendOrderDetailsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendOrderDetailsRequest`
        """
        model = SendOrderDetailsRequest()
        if include_optional:
            return SendOrderDetailsRequest(
                phone = 919876543210,
                chat_id = '',
    ...
    def testSendOrderDetailsRequest(self):
        """Test SendOrderDetailsRequest"""
