...
class TestSendOrderDetailsRequestLanguage(unittest.TestCase):
    """SendOrderDetailsRequestLanguage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendOrderDetailsRequestLanguage:
        """Test SendOrderDetailsRequestLanguage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendOrderDetailsRequestLanguage`
        """
        model = SendOrderDetailsRequestLanguage()
        if include_optional:
            return SendOrderDetailsRequestLanguage(
                code = 'en',
    ...
    def testSendOrderDetailsRequestLanguage(self):
        """Test SendOrderDetailsRequestLanguage"""
