...
class TestSendOrderDetailsRequestOrder(unittest.TestCase):
    """SendOrderDetailsRequestOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendOrderDetailsRequestOrder:
        """Test SendOrderDetailsRequestOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendOrderDetailsRequestOrder`
        """
        model = SendOrderDetailsRequestOrder()
        if include_optional:
            return SendOrderDetailsRequestOrder(
                status = 'pending',
                items = [
                    { }
                    ],
    ...
    def testSendOrderDetailsRequestOrder(self):
        """Test SendOrderDetailsRequestOrder"""
