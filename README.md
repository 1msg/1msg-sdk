...
Public OpenAPI contract: `1.0.0`. 1MSG API service (git tags): `v3.3.0`.
...
```gradle
implementation("io.1msg:sdk:1.0.2")
```
...
```gradle
implementation("io.1msg:sdk-kotlin:1.0.3")
```
...
```scala
libraryDependencies += "io.1msg" %% "sdk-scala" % "1.0.3"
```
...
```bash
go get github.com/1msg/1msg-sdk-go@v1.1.1
```
...
composer require 1msg/sdk:^1.1.1
```
...
|----------|---------------|---------|
| TypeScript | `@1msg/sdk` | 1.0.3 |
| Python | `one-msg-sdk` | 1.0.2 |
