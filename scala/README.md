...
| | |
|---|---|
| **Maven Central** | [`io.1msg:sdk-scala`](https://central.sonatype.com/artifact/io.1msg/sdk-scala_2.13) |
| **Source** | [github.com/1msg/1msg-sdk/scala](https://github.com/1msg/1msg-sdk/tree/main/scala) |
...
<dependency>
  ...
  <artifactId>sdk-scala_2.13</artifactId>
  <version>1.0.3</version>
</dependency>
```

Artifacts: `sdk-scala_2.12` and `sdk-scala_2.13`.
...
val api = new MessagingApi(s"https://api.1msg.io/${sys.env("MSG_INSTANCE_ID")}")
