...
# Unit tests for OneMsgSdk::MessageSentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::MessageSentResponse do
  #let(:instance) { OneMsgSdk::MessageSentResponse.new }

  describe 'test an instance of MessageSentResponse' do
    it 'should create an instance of MessageSentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::MessageSentResponse)
    end
  end
