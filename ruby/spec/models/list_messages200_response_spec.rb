...
# Unit tests for OneMsgSdk::ListMessages200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::ListMessages200Response do
  #let(:instance) { OneMsgSdk::ListMessages200Response.new }

  describe 'test an instance of ListMessages200Response' do
    it 'should create an instance of ListMessages200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::ListMessages200Response)
    end
  end
