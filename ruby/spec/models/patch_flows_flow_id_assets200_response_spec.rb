...
# Unit tests for OneMsgSdk::PatchFlowsFlowIdAssets200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::PatchFlowsFlowIdAssets200Response do
  #let(:instance) { OneMsgSdk::PatchFlowsFlowIdAssets200Response.new }

  describe 'test an instance of PatchFlowsFlowIdAssets200Response' do
    it 'should create an instance of PatchFlowsFlowIdAssets200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::PatchFlowsFlowIdAssets200Response)
    end
  end
