...
# Unit tests for OneMsgSdk::GetMmLiteStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::GetMmLiteStatus200Response do
  #let(:instance) { OneMsgSdk::GetMmLiteStatus200Response.new }

  describe 'test an instance of GetMmLiteStatus200Response' do
    it 'should create an instance of GetMmLiteStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::GetMmLiteStatus200Response)
    end
  end
