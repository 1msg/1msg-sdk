...
# Unit tests for OneMsgSdk::ListFlows200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::ListFlows200Response do
  #let(:instance) { OneMsgSdk::ListFlows200Response.new }

  describe 'test an instance of ListFlows200Response' do
    it 'should create an instance of ListFlows200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::ListFlows200Response)
    end
  end
