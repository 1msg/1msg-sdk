...
# Unit tests for OneMsgSdk::SendOrderDetailsRequestOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendOrderDetailsRequestOrder do
  #let(:instance) { OneMsgSdk::SendOrderDetailsRequestOrder.new }

  describe 'test an instance of SendOrderDetailsRequestOrder' do
    it 'should create an instance of SendOrderDetailsRequestOrder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendOrderDetailsRequestOrder)
    end
  end
