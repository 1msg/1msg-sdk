...
# Unit tests for OneMsgSdk::SendStickerRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendStickerRequest do
  #let(:instance) { OneMsgSdk::SendStickerRequest.new }

  describe 'test an instance of SendStickerRequest' do
    it 'should create an instance of SendStickerRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendStickerRequest)
    end
  end
