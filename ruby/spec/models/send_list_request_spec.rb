...
# Unit tests for OneMsgSdk::SendListRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendListRequest do
  #let(:instance) { OneMsgSdk::SendListRequest.new }

  describe 'test an instance of SendListRequest' do
    it 'should create an instance of SendListRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendListRequest)
    end
  end
