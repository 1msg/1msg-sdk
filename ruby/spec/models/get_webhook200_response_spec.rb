...
# Unit tests for OneMsgSdk::GetWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::GetWebhook200Response do
  #let(:instance) { OneMsgSdk::GetWebhook200Response.new }

  describe 'test an instance of GetWebhook200Response' do
    it 'should create an instance of GetWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::GetWebhook200Response)
    end
  end
