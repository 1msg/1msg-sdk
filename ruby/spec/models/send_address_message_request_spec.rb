...
# Unit tests for OneMsgSdk::SendAddressMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendAddressMessageRequest do
  #let(:instance) { OneMsgSdk::SendAddressMessageRequest.new }

  describe 'test an instance of SendAddressMessageRequest' do
    it 'should create an instance of SendAddressMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendAddressMessageRequest)
    end
  end
  ...
  describe 'test attribute "country"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["IN", "SG"])
