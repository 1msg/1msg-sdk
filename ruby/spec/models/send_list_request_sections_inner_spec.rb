...
# Unit tests for OneMsgSdk::SendListRequestSectionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendListRequestSectionsInner do
  #let(:instance) { OneMsgSdk::SendListRequestSectionsInner.new }

  describe 'test an instance of SendListRequestSectionsInner' do
    it 'should create an instance of SendListRequestSectionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendListRequestSectionsInner)
    end
  end
