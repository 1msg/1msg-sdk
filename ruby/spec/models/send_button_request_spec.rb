...
# Unit tests for OneMsgSdk::SendButtonRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendButtonRequest do
  #let(:instance) { OneMsgSdk::SendButtonRequest.new }

  describe 'test an instance of SendButtonRequest' do
    it 'should create an instance of SendButtonRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendButtonRequest)
    end
  end
