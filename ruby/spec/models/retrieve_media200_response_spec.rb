...
# Unit tests for OneMsgSdk::RetrieveMedia200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::RetrieveMedia200Response do
  #let(:instance) { OneMsgSdk::RetrieveMedia200Response.new }

  describe 'test an instance of RetrieveMedia200Response' do
    it 'should create an instance of RetrieveMedia200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::RetrieveMedia200Response)
    end
  end
