...
# Unit tests for OneMsgSdk::SendContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendContactRequest do
  #let(:instance) { OneMsgSdk::SendContactRequest.new }

  describe 'test an instance of SendContactRequest' do
    it 'should create an instance of SendContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendContactRequest)
    end
  end
