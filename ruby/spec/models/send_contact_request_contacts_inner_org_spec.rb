...
# Unit tests for OneMsgSdk::SendContactRequestContactsInnerOrg
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendContactRequestContactsInnerOrg do
  #let(:instance) { OneMsgSdk::SendContactRequestContactsInnerOrg.new }

  describe 'test an instance of SendContactRequestContactsInnerOrg' do
    it 'should create an instance of SendContactRequestContactsInnerOrg' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendContactRequestContactsInnerOrg)
    end
  end
