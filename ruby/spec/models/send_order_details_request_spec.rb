...
# Unit tests for OneMsgSdk::SendOrderDetailsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendOrderDetailsRequest do
  #let(:instance) { OneMsgSdk::SendOrderDetailsRequest.new }

  describe 'test an instance of SendOrderDetailsRequest' do
    it 'should create an instance of SendOrderDetailsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendOrderDetailsRequest)
    end
  end
