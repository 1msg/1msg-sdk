...
# Unit tests for OneMsgSdk::SendMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendMessageRequest do
  #let(:instance) { OneMsgSdk::SendMessageRequest.new }

  describe 'test an instance of SendMessageRequest' do
    it 'should create an instance of SendMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendMessageRequest)
    end
  end
