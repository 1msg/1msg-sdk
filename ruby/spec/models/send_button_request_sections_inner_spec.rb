...
# Unit tests for OneMsgSdk::SendButtonRequestSectionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendButtonRequestSectionsInner do
  #let(:instance) { OneMsgSdk::SendButtonRequestSectionsInner.new }

  describe 'test an instance of SendButtonRequestSectionsInner' do
    it 'should create an instance of SendButtonRequestSectionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendButtonRequestSectionsInner)
    end
  end
