...
# Unit tests for OneMsgSdk::ListTemplates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::ListTemplates200Response do
  #let(:instance) { OneMsgSdk::ListTemplates200Response.new }

  describe 'test an instance of ListTemplates200Response' do
    it 'should create an instance of ListTemplates200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::ListTemplates200Response)
    end
  end
