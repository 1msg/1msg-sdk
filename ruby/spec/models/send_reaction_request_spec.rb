...
# Unit tests for OneMsgSdk::SendReactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendReactionRequest do
  #let(:instance) { OneMsgSdk::SendReactionRequest.new }

  describe 'test an instance of SendReactionRequest' do
    it 'should create an instance of SendReactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendReactionRequest)
    end
  end
