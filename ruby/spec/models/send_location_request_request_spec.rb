...
# Unit tests for OneMsgSdk::SendLocationRequestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendLocationRequestRequest do
  #let(:instance) { OneMsgSdk::SendLocationRequestRequest.new }

  describe 'test an instance of SendLocationRequestRequest' do
    it 'should create an instance of SendLocationRequestRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendLocationRequestRequest)
    end
  end
