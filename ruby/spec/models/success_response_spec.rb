...
# Unit tests for OneMsgSdk::SuccessResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SuccessResponse do
  #let(:instance) { OneMsgSdk::SuccessResponse.new }

  describe 'test an instance of SuccessResponse' do
    it 'should create an instance of SuccessResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SuccessResponse)
    end
  end
