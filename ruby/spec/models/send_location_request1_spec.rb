...
# Unit tests for OneMsgSdk::SendLocationRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendLocationRequest1 do
  #let(:instance) { OneMsgSdk::SendLocationRequest1.new }

  describe 'test an instance of SendLocationRequest1' do
    it 'should create an instance of SendLocationRequest1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendLocationRequest1)
    end
  end
