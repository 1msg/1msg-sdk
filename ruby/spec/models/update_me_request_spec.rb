...
# Unit tests for OneMsgSdk::UpdateMeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::UpdateMeRequest do
  #let(:instance) { OneMsgSdk::UpdateMeRequest.new }

  describe 'test an instance of UpdateMeRequest' do
    it 'should create an instance of UpdateMeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::UpdateMeRequest)
    end
  end
