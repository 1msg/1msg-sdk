...
# Unit tests for OneMsgSdk::SendCarouselRequest1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneMsgSdk::SendCarouselRequest1 do
  #let(:instance) { OneMsgSdk::SendCarouselRequest1.new }

  describe 'test an instance of SendCarouselRequest1' do
    it 'should create an instance of SendCarouselRequest1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OneMsgSdk::SendCarouselRequest1)
    end
  end
