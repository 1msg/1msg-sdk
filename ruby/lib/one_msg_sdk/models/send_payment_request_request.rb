...
module OneMsgSdk
  class SendPaymentRequestRequest < ApiModelBase
    attr_accessor :phone
    ...
    def self.openapi_types
      {
        ...
        :'region' => :'String',
        :'body' => :'String',
        :'interactive' => :'Hash<String, Object>',
        :'action' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OneMsgSdk::SendPaymentRequestRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OneMsgSdk::SendPaymentRequestRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'interactive')
        if (value = attributes[:'interactive']).is_a?(Hash)
          self.interactive = value
        end
      end

      if attributes.key?(:'action')
        if (value = attributes[:'action']).is_a?(Hash)
          self.action = value
        end
      end
    end
    ...
    def valid?
      ...
      region_validator = EnumAttributeValidator.new('String', ["IN", "SG", "BR"])
    ...
    def region=(region)
      validator = EnumAttributeValidator.new('String', ["IN", "SG", "BR"])
    ...
    def hash
      [phone, region, body, interactive, action].hash
    end
