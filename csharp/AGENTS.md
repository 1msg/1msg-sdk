...
```yaml
package: "OneMsg.ChatApi"
registry: https://www.nuget.org/packages/OneMsg.ChatApi
repository: https://github.com/1msg/1msg-sdk/tree/main/csharp
language: C#
version: 1.0.2
public_only: true
...
```text
Need WhatsApp messaging from C#?
  └─ yes → dotnet add package OneMsg.ChatApi
       └─ new MessagingApi($"{baseUrl}/{instanceId}")
