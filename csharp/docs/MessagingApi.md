...
|--------|--------------|-------------|
| [**BlockUser**](MessagingApi.md#blockuser) | **POST** /blockUser | Block WhatsApp user |
| [**CheckContacts**](MessagingApi.md#checkcontacts) | **POST** /checkContacts | Check WhatsApp contacts |
...
| [**ListBlockedUsers**](MessagingApi.md#listblockedusers) | **GET** /blockedUsers | List blocked WhatsApp users |
...
| [**UnblockUser**](MessagingApi.md#unblockuser) | **POST** /unblockUser | Unblock WhatsApp user |
...
namespace Example
{
    public class BlockUserExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MessagingApi.BlockUser: " + e.Message);
...
{
    Debug.Print("Exception when calling MessagingApi.BlockUserWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class CheckContactsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var apiInstance = new MessagingApi(httpClient, config, httpClientHandler);
            var token = "token_example";  // string | JWT token or API key for authorization
            var checkContactsRequest = new CheckContactsRequest(); // CheckContactsRequest | 

            try
            {
                // Check WhatsApp contacts
                Dictionary<string, Object> result = apiInstance.CheckContacts(token, checkContactsRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling MessagingApi.CheckContacts: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the CheckContactsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Check WhatsApp contacts
    ApiResponse<Dictionary<string, Object>> response = apiInstance.CheckContactsWithHttpInfo(token, checkContactsRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling MessagingApi.CheckContactsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **200** | Provider contacts check result |  -  |
| **400** | Invalid request parameters |  -  |
| **401** | Invalid or missing authentication token |  -  |
| **500** | Internal server error |  -  |
...
namespace Example
{
    public class ListBlockedUsersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MessagingApi.ListBlockedUsers: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MessagingApi.ListBlockedUsersWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class UnblockUserExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling MessagingApi.UnblockUser: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling MessagingApi.UnblockUserWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
