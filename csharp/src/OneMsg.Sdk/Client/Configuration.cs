...
namespace OneMsg.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.0.1/csharp");
            BasePath = "https://api.1msg.io";
        ...
        public Configuration(
            ...
            string basePath = "https://api.1msg.io") : this()
        {
        ...
        {
            string report = "C# SDK (OneMsg.Sdk) Debug Report:\n";
