...
| | |
|---|---|
| **NuGet** | [`OneMsg.Sdk`](https://www.nuget.org/packages/OneMsg.Sdk) |
| **Source** | [github.com/1msg/1msg-sdk/csharp](https://github.com/1msg/1msg-sdk/tree/main/csharp) |
...
```xml
<PackageReference Include="OneMsg.Sdk" Version="2.0.0" />
```
...
NuGet package id is `OneMsg.Sdk`. Namespaces live under `OneMsg.Sdk`.
