...
namespace OneMsg.ChatApi.Model
{
    ...
    /// SendReactionRequest
    /// </summary>
    [DataContract(Name = "sendReaction_request")]
    public partial class SendReactionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendReactionRequest" /> class.
        /// </summary>
        /// <param name="phone">phone.</param>
        /// <param name="body">body.</param>
        /// <param name="quotedMsgId">quotedMsgId.</param>
        public SendReactionRequest(string phone = default, string body = default, string quotedMsgId = default)
        {
            this.Phone = phone;
            this.Body = body;
