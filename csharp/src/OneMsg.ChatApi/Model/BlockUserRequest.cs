...
namespace OneMsg.ChatApi.Model
{
    ...
    /// BlockUserRequest
    /// </summary>
    [DataContract(Name = "blockUser_request")]
    public partial class BlockUserRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockUserRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BlockUserRequest()
        {
        ...
        public BlockUserRequest(int phone = default)
        {
            this.Phone = phone;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
