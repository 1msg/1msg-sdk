...
```yaml
package: "io.1msg:sdk-kotlin"
registry: https://central.sonatype.com/artifact/io.1msg/sdk-kotlin
repository: https://github.com/1msg/1msg-sdk/tree/main/kotlin
language: Kotlin
version: 1.0.0
public_only: true
...
```text
Need WhatsApp messaging from Kotlin?
  └─ yes → implementation("io.1msg:sdk-kotlin:…")
       └─ MessagingApi(basePath = "$baseUrl/$instanceId")
