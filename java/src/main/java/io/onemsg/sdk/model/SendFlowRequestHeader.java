...
@JsonDeserialize(using = SendFlowRequestHeader.SendFlowRequestHeaderDeserializer.class)
@JsonSerialize(using = SendFlowRequestHeader.SendFlowRequestHeaderSerializer.class)
public class SendFlowRequestHeader extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SendFlowRequestHeader.class.getName());

    public static class SendFlowRequestHeaderSerializer extends StdSerializer<SendFlowRequestHeader> {
        public SendFlowRequestHeaderSerializer(Class<SendFlowRequestHeader> t) {
            super(t);
        }

        public SendFlowRequestHeaderSerializer() {
            this(null);
        }

        @Override
        public void serialize(SendFlowRequestHeader value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SendFlowRequestHeaderDeserializer extends StdDeserializer<SendFlowRequestHeader> {
        public SendFlowRequestHeaderDeserializer() {
            this(SendFlowRequestHeader.class);
        }

        public SendFlowRequestHeaderDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SendFlowRequestHeader deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SendFlowRequestHeader ret = new SendFlowRequestHeader();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SendFlowRequestHeader: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SendFlowRequestHeader getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SendFlowRequestHeader cannot be null");
        }
    }
    ...
    public SendFlowRequestHeader() {
        super("oneOf", Boolean.FALSE);
    }

    public SendFlowRequestHeader(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SendFlowRequestHeader(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SendFlowRequestHeader.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SendFlowRequestHeader.schemas;
    }
