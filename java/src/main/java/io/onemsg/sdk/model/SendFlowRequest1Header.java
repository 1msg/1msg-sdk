...
@JsonDeserialize(using = SendFlowRequest1Header.SendFlowRequest1HeaderDeserializer.class)
@JsonSerialize(using = SendFlowRequest1Header.SendFlowRequest1HeaderSerializer.class)
public class SendFlowRequest1Header extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SendFlowRequest1Header.class.getName());

    public static class SendFlowRequest1HeaderSerializer extends StdSerializer<SendFlowRequest1Header> {
        public SendFlowRequest1HeaderSerializer(Class<SendFlowRequest1Header> t) {
            super(t);
        }

        public SendFlowRequest1HeaderSerializer() {
            this(null);
        }

        @Override
        public void serialize(SendFlowRequest1Header value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SendFlowRequest1HeaderDeserializer extends StdDeserializer<SendFlowRequest1Header> {
        public SendFlowRequest1HeaderDeserializer() {
            this(SendFlowRequest1Header.class);
        }

        public SendFlowRequest1HeaderDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SendFlowRequest1Header deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                SendFlowRequest1Header ret = new SendFlowRequest1Header();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SendFlowRequest1Header: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public SendFlowRequest1Header getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SendFlowRequest1Header cannot be null");
        }
    }
    ...
    public SendFlowRequest1Header() {
        super("oneOf", Boolean.FALSE);
    }

    public SendFlowRequest1Header(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SendFlowRequest1Header(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SendFlowRequest1Header.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return SendFlowRequest1Header.schemas;
    }
