...
```yaml
package: "one-msg-sdk"
registry: https://crates.io/crates/one-msg-sdk
repository: https://github.com/1msg/1msg-sdk/tree/main/rust
language: Rust
version: 2.0.0
public_only: true
...
```text
Need WhatsApp messaging from Rust?
  └─ yes → cargo add one-msg-sdk
       └─ Configuration.base_path = baseUrl/instanceId
