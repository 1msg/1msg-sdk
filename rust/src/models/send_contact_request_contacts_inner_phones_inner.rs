...
pub struct SendContactRequestContactsInnerPhonesInner {
    #[serde(rename = "phone", skip_serializing_if = "Option::is_none")]
    pub phone: Option<String>,
    #[serde(rename = "type", skip_serializing_if = "Option::is_none")]
    pub r#type: Option<String>,
    #[serde(rename = "wa_id", skip_serializing_if = "Option::is_none")]
    pub wa_id: Option<String>,
}

impl SendContactRequestContactsInnerPhonesInner {
    pub fn new() -> SendContactRequestContactsInnerPhonesInner {
