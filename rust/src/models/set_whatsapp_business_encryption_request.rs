...
pub struct SetWhatsappBusinessEncryptionRequest {
    /// 2048-bit RSA public key in PEM format
    #[serde(rename = "business_public_key")]
    pub business_public_key: String,
}

impl SetWhatsappBusinessEncryptionRequest {
    pub fn new(business_public_key: String) -> SetWhatsappBusinessEncryptionRequest {
