...
/// CallingSettingsCallingAudio : Audio settings (typically response-only)
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CallingSettingsCallingAudio {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl CallingSettingsCallingAudio {
    /// Audio settings (typically response-only)
    pub fn new() -> CallingSettingsCallingAudio {
