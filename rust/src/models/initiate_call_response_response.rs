...
/// InitiateCallResponseResponse : Present when 1msg wraps an upstream error
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InitiateCallResponseResponse {
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl InitiateCallResponseResponse {
    /// Present when 1msg wraps an upstream error
    pub fn new() -> InitiateCallResponseResponse {
