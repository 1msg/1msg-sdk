...
pub struct ListBlockedUsers200Response {
    #[serde(rename = "blockedUsers", skip_serializing_if = "Option::is_none")]
    pub blocked_users: Option<Vec<std::collections::HashMap<String, serde_json::Value>>>,
}

impl ListBlockedUsers200Response {
    pub fn new() -> ListBlockedUsers200Response {
